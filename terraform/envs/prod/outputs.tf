...
output "backend_prod_role_arn"       { value = module.iam.backend_role_arn }
output "frontend_prod_role_arn"      { value = module.iam.frontend_role_arn }
output "database_prod_role_arn"      { value = module.iam.database_role_arn }
output "eso_irsa_role_arn"           { value = module.eso_irsa.role_arn }
output "alb_irsa_role_arn"           { value = module.alb_irsa.role_arn }
output "app_namespace"               { value = module.k8s_namespaces.namespace }
